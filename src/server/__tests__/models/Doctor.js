...
describe('Doctor model', () => {
  ...
  describe('Validations', () => {
    ...
    it('should return an error when I try to save a doctor without required fields', async () => {
      ...
      try {
        ...
        expect(e.errors._user_id.message).toEqual('É necessário informar o usuário');
        expect(e.errors.medical_speciality.message).toEqual('É necessário informar a especialidade');
      }
    });
    ...
    it('should return an error when I try to save a doctor with a medical speciality with less than 3 characters', async () => {
      ...
      try {
        ...
        expect(e.errors.medical_speciality.message).toEqual('A especialidade deve ter pelo menos 3 caracteres');
      }
    });
  ...
  describe('Relationship', () => {
    ...
    it('should retrieve a user from doctor model', async () => {
      ...
      expect(doctorUser._id.toHexString()).toEqual(user._id.toHexString());
    });
  });
